CREATE DATABASE  IF NOT EXISTS `tfc` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `tfc`;
...
CREATE TABLE `ejercicio` (
  ...
  `tiempoReaccion` int(11) DEFAULT NULL,
  `sesion` int(11) DEFAULT NULL,
  `tiempoInicio` int(11) DEFAULT NULL,
  `tiempoFinal` int(11) DEFAULT NULL,
...
-- Dump completed on 2012-01-24 19:44:16
